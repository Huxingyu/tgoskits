...
> 当前最终分支：`openrace/task1-rt-partition`
>
> 本文是当前交付分支的 Task 2 canonical 摘要。历史迁移记录仍保留在
> `openrace/task2-net-clean`，但评审应以本文、`scripts/test/net-dual-guest/README.md`
> 和 Task 3 的当前结果目录为准。
...
| 项目 | Linux/控制 Guest | Zephyr/RTOS Guest |
|---|---|---|
...
当前 HEAD 实测：协议 21 个 Rust 测试通过，模型/网络回归测试通过。
