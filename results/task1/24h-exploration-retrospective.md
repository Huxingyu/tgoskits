...
> **HISTORICAL RECORD (2026-08-21)**：本文保留完整探索过程和当时的失败/
> 未完成判断。当前实现状态以 `two-gap-closure-20260820.md`、
> `irq-tail-preemption-design.md` 和最终评分表为准；不要直接使用本文早期
> 的分数或“抢占未完成”等历史描述代表当前 HEAD。
