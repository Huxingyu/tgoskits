...
# Run the same persistent StarryOS/Zephyr ncnn/YOLO/T2N1 workload under AxVisor RR
# and bounded FP-RR, then retain and verify both evidence archives.
...
zephyr_vm="$repo_root/scripts/test/net-dual-guest/vm-aarch64-zephyr-task1-shared.toml"
...
experiment=starryos-zephyr-task1-scheduler-ab
...
run_arm() {
    ...
    STARRY_TASK23_HOST_CONFIG="$host_config" \
        ...
        STARRY_TASK23_ZEPHYR_VM_CONFIG="$zephyr_vm" \
